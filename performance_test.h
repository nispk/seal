...
//This header file includes all the helper functions used in the performance testing.


/*
This function is used to discretize the inputs of the network
*/
inline int64_t discrete(double x)
{
    // int scale = 10;
...
*/
inline int64_t discreteW(double x)
{
    int scale = 2;
...
/*
For an input x, this function returns the sign(x).
*/
