...
void print_to_csv(vector<int> csv_data, vector<string> csv_column_name, size_t mod)
{
    size_t column_size = csv_data.size();

    ofstream out("sec_level_256.csv", std::fstream::app);
    ...
    if (mod == 4096)
    {
        cout << "polynomial_modulus"
             << ",";
        for (size_t i = 0; i < column_size; i++)
            cout << csv_column_name[i] << ",";
    }
    cout << endl;

    size_t polynomial_modulus[4] = { 4096, 8192, 16384, 32768 };
...
void bfv_performance_test(shared_ptr<SEALContext> context)
{
    ...
    */
    ...
    csv_data.push_back(avg_batch);
    csv_column_name.push_back("avg_batch_bfv");
    csv_data.push_back(avg_unbatch);
    csv_column_name.push_back("avg_unbatch_bfv");
    csv_data.push_back(avg_encrypt);
    csv_column_name.push_back("avg_encrypt_bfv");
    csv_data.push_back(avg_decrypt);
    csv_column_name.push_back("avg_decrypt_bfv");
    csv_data.push_back(avg_add);
    csv_column_name.push_back("avg_add_bfv");
    csv_data.push_back(avg_multiply);
    csv_column_name.push_back("avg_multiply_bfv");
    csv_data.push_back(avg_multiply_plain);
    csv_column_name.push_back("avg_multiply_plain_bfv");
    csv_data.push_back(avg_square);
    csv_column_name.push_back("avg_square_bfv");
    csv_data.push_back(avg_relinearize);
    csv_column_name.push_back("avg_relenearize_bfv");
    csv_data.push_back(avg_rotate_rows_one_step);
    csv_column_name.push_back("avg_rotate_rows_one_step_bfv");
    csv_data.push_back(avg_rotate_rows_random);
    csv_column_name.push_back("avg_rotate_rows_random_bfv");
    csv_data.push_back(avg_rotate_columns);
    csv_column_name.push_back("avg_rotate_columns_bfv");
    ...
    print_to_csv(csv_data, csv_column_name, poly_modulus_degree);
    csv_data.clear();
    csv_column_name.clear();
...
void ckks_performance_test(shared_ptr<SEALContext> context)
{
    ...
    */
    ...
    csv_data.push_back(avg_encode);
    csv_column_name.push_back("avg_encode_ckks");
    auto avg_decode = time_decode_sum.count() / count;
    csv_column_name.push_back("avg_decode_ckks");
    csv_data.push_back(avg_decode);
    auto avg_encrypt = time_encrypt_sum.count() / count;
    csv_data.push_back(avg_encrypt);
    csv_column_name.push_back("avg_encrypt_ckks");
    auto avg_decrypt = time_decrypt_sum.count() / count;
    csv_data.push_back(avg_decrypt);
    csv_column_name.push_back("avg_decrypt_ckks");
    auto avg_add = time_add_sum.count() / (3 * count);
    csv_data.push_back(avg_add);
    csv_column_name.push_back("avg_add_ckks");
    auto avg_multiply = time_multiply_sum.count() / count;
    csv_data.push_back(avg_multiply);
    csv_column_name.push_back("avg_multiply_ckks");
    auto avg_multiply_plain = time_multiply_plain_sum.count() / count;
    csv_data.push_back(avg_multiply_plain);
    csv_column_name.push_back("avg_multiply_plain_ckks");
    auto avg_square = time_square_sum.count() / count;
    csv_data.push_back(avg_square);
    csv_column_name.push_back("avg_square_ckks");
    auto avg_relinearize = time_relinearize_sum.count() / count;
    csv_data.push_back(avg_relinearize);
    csv_column_name.push_back("avg_relinearize_ckks");
    auto avg_rescale = time_rescale_sum.count() / count;
    csv_data.push_back(avg_rescale);
    csv_column_name.push_back("avg_rescale_ckks");
    auto avg_rotate_one_step = time_rotate_one_step_sum.count() / (2 * count);
    csv_column_name.push_back("avg_rotate_one_step_ckks");
    csv_data.push_back(avg_rotate_one_step);
    auto avg_rotate_random = time_rotate_random_sum.count() / count;
    csv_data.push_back(avg_rotate_random);
    csv_column_name.push_back("avg_rotate_random_ckks");
    auto avg_conjugate = time_conjugate_sum.count() / count;
    csv_data.push_back(avg_conjugate);
    csv_column_name.push_back("avg_conjugate_ckks");
...
void example_ckks_performance_custom()
{
    ...
    ofstream out("security_level_256_1024.txt");
    streambuf *coutbuf = cout.rdbuf();
    cout.rdbuf(out.rdbuf());
