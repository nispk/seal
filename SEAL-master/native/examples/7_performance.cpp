...
void bfv_performance_test(shared_ptr<SEALContext> context)
{
    ...
    //nishu
    cout << " public key size of bfv " << sizeof(public_key) << endl;
    cout << " secret key size of bfv is " << sizeof(secret_key) << endl;
    ...
    */
    ...
    for (long long i = 0; i < count; i++)
    {
        ...
        */
        ...
        //nishu
        cout << " size of ciphertext in bfv scheme is " << sizeof(encrypted) << endl;
        time_end = chrono::high_resolution_clock::now();
...
void ckks_performance_test(shared_ptr<SEALContext> context)
{
    ...
    cout << " public key size of ckks " << sizeof(public_key) << endl;
    cout << " secret key size of ckks is " << sizeof(secret_key) << endl;
    ...
    */
    ...
    for (long long i = 0; i < count; i++)
    {
        ...
        */
        ...
        encryptor.encrypt(plain, encrypted);
        // nishu
        cout << " size of ciphertext in ckks scheme is " << sizeof(encrypted) << endl;
        time_end = chrono::high_resolution_clock::now();
        time_encrypt_sum += chrono::duration_cast<chrono::microseconds>(time_end - time_start);
